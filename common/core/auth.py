...
def decode_authorization_payload(authorization: str) -> TokenPayload:
    ...
    return decode_token_payload(authorization.split(" ")[1])
...
async def get_current_user_id(
    ...
    """
    return decode_authorization_payload(authorization).sub
